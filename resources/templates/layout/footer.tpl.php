	...
	<div class="footer__container">
		...
		<div class="fifth-footer-column">
			...
			<div class="social-icons">
				<a href="https://www.facebook.com/gowillamettevalley" target="_blank" rel="nofollow" aria-label="facebook"><img src="<?= get_stylesheet_directory_uri();?>/resources/assets/images/facebook.png"></a>
				<a href="http://instagram.com/gowillamettevalley" target="_blank" rel="nofollow" aria-label="instagram"><img src="<?= get_stylesheet_directory_uri();?>/resources/assets/images/instagram.png"></a>
				<!-- <a href="https://www.youtube.com/user/gowillamettevalley/" target="_blank" rel="nofollow" aria-label="youtube"><img src="<?= get_stylesheet_directory_uri();?>/resources/assets/images/youtube.png"></a> -->
				<!--<a href="https://twitter.com/gowillamettevalley" target="_blank" rel="nofollow" aria-label="twitter"><img src="<?= get_stylesheet_directory_uri();?>/resources/assets/images/twitter.png"></a> -->
				<a href="https://www.pinterest.com/gowillamettevalley/" target="_blank" rel="nofollow" aria-label="pinterest"><img src="<?= get_stylesheet_directory_uri();?>/resources/assets/images/pinterest.png"></a>
			</div>
		</div>
	</div>
</footer> <!-- footer.tpl -->
